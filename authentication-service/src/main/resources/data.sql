...
INSERT INTO `xml`.`users` (`type`, `id`, `address`, `city`, `country`, `email`, `enabled`, `password`, `phone`, `username`, `last_name`, `first_name`,`advertisements_posted`, `deleted`, `can_create_pricelist`, `can_rent`, `can_send_message`, `can_post_advertisement`) VALUES ('CUSTOMER', '4', 'Janka Veselinovica 1', 'Novi Sad', 'Serbia', 'marko@gmail.com', b'1', '$2a$10$1hoVKaxcWC6/T/.NSGcOm.F7E8vT2xbuJfFuIWEl4hexg28P09CJm', '0651111111', 'markomarkovic', 'Markovic', 'Marko','0', b'0', b'1', b'1', b'1', b'1');
