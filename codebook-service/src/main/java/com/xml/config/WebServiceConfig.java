...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    @Bean(name = "pricelistSchema")
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema pricelistSchema) {
        DefaultWsdl11Definition wsdl11Definition = new DefaultWsdl11Definition();
        wsdl11Definition.setPortTypeName("pricelistSchemaPort");
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://localhost:8084/codebook-service-schema");
